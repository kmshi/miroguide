...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flag.id'
        db.add_column('cg_channel_flags', 'id', orm['flags.flag:id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Flag.id'
        db.delete_column('cg_channel_flags', 'id')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 19, 12, 51, 982827)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 19, 12, 51, 982702)'}),
