...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cg_channel_language', (
            ('id', orm['labels.Language:id']),
            ('name', orm['labels.Language:name']),
        ))
        db.send_create_signal('labels', ['Language'])
        
        # Adding model 'Tag'
        db.create_table('cg_tag', (
            ('id', orm['labels.Tag:id']),
            ('name', orm['labels.Tag:name']),
        ))
        db.send_create_signal('labels', ['Tag'])
        
        # Adding model 'Category'
        db.create_table('cg_category', (
            ('id', orm['labels.Category:id']),
            ('on_frontpage', orm['labels.Category:on_frontpage']),
            ('name', orm['labels.Category:name']),
        ))
        db.send_create_signal('labels', ['Category'])
        
        # Adding model 'TagMap'
        db.create_table('cg_tag_map', (
            ('tag', orm['labels.TagMap:tag']),
            ('channel', orm['labels.TagMap:channel']),
            ('user', orm['labels.TagMap:user']),
        ))
        db.send_create_signal('labels', ['TagMap'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cg_channel_language')
        
        # Deleting model 'Tag'
        db.delete_table('cg_tag')
        
        # Deleting model 'Category'
        db.delete_table('cg_category')
        
        # Deleting model 'TagMap'
        db.delete_table('cg_tag_map')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 10, 17, 9, 18, 406251)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 10, 17, 9, 18, 406123)'}),
