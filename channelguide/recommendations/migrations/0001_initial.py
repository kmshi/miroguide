...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cg_channel_recommendations', (
            ('channel2', orm['recommendations.Similarity:channel2']),
            ('channel1', orm['recommendations.Similarity:channel1']),
            ('cosine', orm['recommendations.Similarity:cosine']),
        ))
        db.send_create_signal('recommendations', ['Similarity'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cg_channel_recommendations')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 15, 52, 35, 349233)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 15, 52, 35, 349102)'}),
