...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.create_primary_key('cg_channel_featured_email', ['channel_id', 'timestamp'])
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 19, 14, 10, 730528)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 19, 14, 10, 730399)'}),
